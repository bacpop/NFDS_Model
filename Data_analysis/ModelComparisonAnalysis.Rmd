...
Nepal_2_bic<- -2 * (Nepal_likelihood_2param) + log(2001) * 2 # 2478.225
Nepal_3_bic<- -2 * (Nepal_likelihood_3param) + log(2001) * 3 # 2246.297 # but the fit is very bad
Nepal_4_bic<- -2 * (Nepal_likelihood_4param) + log(2001) * 4 # 2290.608
Nepal_5_bic<- -2 * (Nepal_likelihood_5param) + log(2001) * 5 # 2298.382
```
