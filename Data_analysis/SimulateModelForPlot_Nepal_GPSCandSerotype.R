...
if(model_version == "4"){
  ...
  params_4_model_data_list <- simulate_model_for_plot2(fit_4param_mcmc2_probs_pars, params_4_woFit)
  params_4_model_data_GPSCS <- params_4_model_data_list[[1]] # GPSC counts
  params_4_model_data_sero <- params_4_model_data_list[[2]] # serotype counts
