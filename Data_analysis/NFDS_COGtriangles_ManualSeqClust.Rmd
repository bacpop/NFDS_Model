...
PPxSero <- readRDS("/Users/llorenz/Documents/PhD_Project/Code/1st_project/WF_plots_postTAC/2024_10_16/Mass_PPxSero_NewStart/Mass_PPxSero_NewStart/PPxSero_ggCaller_PopPUNK_det_pmcmc_run2.rds")
# Mass, 05.12.2024
# this is with GPSCs instead of PopPUNK clusters
PPxSero <- readRDS("/Users/llorenz/Documents/PhD_Project/Code/1st_project/WF_plots_postTAC/2024_12_05/ModelComparison_Mass/PPxSero_ggCaller_PopPUNK_4param_det_pmcmc_run2.rds")
PPxSero_mcmc <- coda::as.mcmc(cbind(PPxSero$probabilities, PPxSero$pars))

rand_ind <- sample(x = 1:nrow(PPxSero_mcmc), size = 1000, replace = FALSE)
rand_ind <- sample(x = 1:nrow(PPxSero_mcmc), size = 200, replace = FALSE)
WF_PPxSero <- odin.dust::odin_dust("NFDS_Model_PPxSero.R")
empty_vec <- rep(0,PP_mass_clusters)
...
saveRDS(cluster_samples_ParamVar, "cluster_samples_ParamVar200.rds")
...
PPxSero_Null <- readRDS("/Users/llorenz/Documents/PhD_Project/Code/1st_project/WF_plots_postTAC/2024_10_11/Mass_PPxSeroNull/PPxSero_ggCaller_PopPUNK_det_pmcmc_run2.rds")
# new one with GPSC names...?
PPxSero_Null <- readRDS("/Users/llorenz/Documents/PhD_Project/Code/1st_project/WF_plots_postTAC/2024_12_05/ModelComparison_Mass/PPxSero_ggCaller_PopPUNK_Null_det_pmcmc_run2.rds")
PPxSero_Null_mcmc <- coda::as.mcmc(cbind(PPxSero_Null$probabilities, PPxSero_Null$pars))

rand_ind <- sample(x = 1:nrow(PPxSero_Null_mcmc), size = 1000, replace = FALSE)
rand_ind <- sample(x = 1:nrow(PPxSero_Null_mcmc), size = 200, replace = FALSE)
WF_PPxSero <- odin.dust::odin_dust("NFDS_Model_PPxSero.R")
empty_vec <- rep(0,PP_mass_clusters)
cluster_samples_ParamVar_Null <- array(rep(empty_vec,length(rand_ind)),dim = c(length(rand_ind),PP_mass_clusters))
...
saveRDS(cluster_samples_ParamVar_Null, "cluster_samples_ParamVar_Null200.rds")
...
# ideally, I could connect the three values of the same cluster somehow 
# but it's not working yet
# geom_line(position = position_dodge(.5), aes(group = cluster)) + 
...
ggplot(data_and_model_with_errors_and_null_large_clusters, aes(fill = VT,y=values, x=xvals,group = Group, color = Group)) + 
    geom_point(position = position_dodge(.5), stat="identity",size = 1.5) +
  geom_errorbar( aes(ymin=lower, ymax=upper), width=0.5, alpha=0.9, size=1,position=position_dodge(.5)) +
  scale_x_continuous("Strains", breaks = 1:(length(non_small_cluster_idx)), labels = unique(PopPUNK_clusters$Cluster)[non_small_cluster_idx]) +
  #scale_fill_manual(values=c( "orange","#999999","#D32F2F"),labels = c("Mixed", "Non-Vaccine Types","Vaccine Types"))+theme_minimal() +
  scale_color_manual(values = c("black", "#0072B2", "#CC79A7"),labels = c("Data", "NFDS Model","Neutral Model")) +
...
data_and_model_with_errors_and_null_large_clusters_nameByVT <- data_and_model_with_errors_and_null_large_clusters

data_and_model_with_errors_and_null_large_clusters_nameByVT$xvals[which(data_and_model_with_errors_and_null_large_clusters$VT == "mixed" & data_and_model_with_errors_and_null_large_clusters$Group == "Data")] <- 1:length(which(data_and_model_with_errors_and_null_large_clusters$VT == "mixed" & data_and_model_with_errors_and_null_large_clusters$Group == "Data")) 
data_and_model_with_errors_and_null_large_clusters_nameByVT$xvals[which(data_and_model_with_errors_and_null_large_clusters$VT == "mixed" & data_and_model_with_errors_and_null_large_clusters$Group == "NFDS Model")] <- 1:length(which(data_and_model_with_errors_and_null_large_clusters$VT == "mixed" & data_and_model_with_errors_and_null_large_clusters$Group == "Data")) 
data_and_model_with_errors_and_null_large_clusters_nameByVT$xvals[which(data_and_model_with_errors_and_null_large_clusters$VT == "mixed" & data_and_model_with_errors_and_null_large_clusters$Group == "Null Model")] <- 1:length(which(data_and_model_with_errors_and_null_large_clusters$VT == "mixed" & data_and_model_with_errors_and_null_large_clusters$Group == "Data"))

data_and_model_with_errors_and_null_large_clusters_nameByVT$xvals[which(data_and_model_with_errors_and_null_large_clusters$VT == "VT" & data_and_model_with_errors_and_null_large_clusters$Group == "Data")] <- (1:length(which(data_and_model_with_errors_and_null_large_clusters$VT == "VT" & data_and_model_with_errors_and_null_large_clusters$Group == "Data")) ) + length(which(data_and_model_with_errors_and_null_large_clusters$VT == "mixed" & data_and_model_with_errors_and_null_large_clusters$Group == "Data"))
data_and_model_with_errors_and_null_large_clusters_nameByVT$xvals[which(data_and_model_with_errors_and_null_large_clusters$VT == "VT" & data_and_model_with_errors_and_null_large_clusters$Group == "NFDS Model")] <- (1:length(which(data_and_model_with_errors_and_null_large_clusters$VT == "VT" & data_and_model_with_errors_and_null_large_clusters$Group == "Data")) ) + length(which(data_and_model_with_errors_and_null_large_clusters$VT == "mixed" & data_and_model_with_errors_and_null_large_clusters$Group == "Data"))
data_and_model_with_errors_and_null_large_clusters_nameByVT$xvals[which(data_and_model_with_errors_and_null_large_clusters$VT == "VT" & data_and_model_with_errors_and_null_large_clusters$Group == "Null Model")] <- (1:length(which(data_and_model_with_errors_and_null_large_clusters$VT == "VT" & data_and_model_with_errors_and_null_large_clusters$Group == "Data")) ) + length(which(data_and_model_with_errors_and_null_large_clusters$VT == "mixed" & data_and_model_with_errors_and_null_large_clusters$Group == "Data"))

data_and_model_with_errors_and_null_large_clusters_nameByVT$xvals[which(data_and_model_with_errors_and_null_large_clusters$VT == "NVT" & data_and_model_with_errors_and_null_large_clusters$Group == "Data")] <- (1:length(which(data_and_model_with_errors_and_null_large_clusters$VT == "NVT" & data_and_model_with_errors_and_null_large_clusters$Group == "Data")) ) + length(which(data_and_model_with_errors_and_null_large_clusters$VT == "mixed" & data_and_model_with_errors_and_null_large_clusters$Group == "Data")) + length(which(data_and_model_with_errors_and_null_large_clusters$VT == "NVT" & data_and_model_with_errors_and_null_large_clusters$Group == "Data"))
data_and_model_with_errors_and_null_large_clusters_nameByVT$xvals[which(data_and_model_with_errors_and_null_large_clusters$VT == "NVT" & data_and_model_with_errors_and_null_large_clusters$Group == "NFDS Model")] <- (1:length(which(data_and_model_with_errors_and_null_large_clusters$VT == "NVT" & data_and_model_with_errors_and_null_large_clusters$Group == "Data")) ) + length(which(data_and_model_with_errors_and_null_large_clusters$VT == "mixed" & data_and_model_with_errors_and_null_large_clusters$Group == "Data")) + length(which(data_and_model_with_errors_and_null_large_clusters$VT == "NVT" & data_and_model_with_errors_and_null_large_clusters$Group == "Data"))
data_and_model_with_errors_and_null_large_clusters_nameByVT$xvals[which(data_and_model_with_errors_and_null_large_clusters$VT == "NVT" & data_and_model_with_errors_and_null_large_clusters$Group == "Null Model")] <- (1:length(which(data_and_model_with_errors_and_null_large_clusters$VT == "NVT" & data_and_model_with_errors_and_null_large_clusters$Group == "Data")) ) + length(which(data_and_model_with_errors_and_null_large_clusters$VT == "mixed" & data_and_model_with_errors_and_null_large_clusters$Group == "Data")) + length(which(data_and_model_with_errors_and_null_large_clusters$VT == "NVT" & data_and_model_with_errors_and_null_large_clusters$Group == "Data"))

xvals_to_cluster <-  unique(data_and_model_with_errors_and_null_large_clusters_nameByVT$cluster)
names(xvals_to_cluster) <- unique(data_and_model_with_errors_and_null_large_clusters_nameByVT$xvals)

errorbar_plot <- ggplot(data_and_model_with_errors_and_null_large_clusters_nameByVT, aes(fill = VT,y=values, x=xvals,group = Group, color = Group)) + 
    geom_point(position = position_dodge(.5), stat="identity",size = 1.5) +
  geom_errorbar( aes(ymin=lower, ymax=upper), width=0.5, alpha=0.9, size=1,position=position_dodge(.5)) +
  #scale_x_continuous("Strains", breaks = 1:(length(non_small_cluster_idx)), labels = unique(PopPUNK_clusters$Cluster)[non_small_cluster_idx]) +
  #scale_x_continuous("Strains", breaks = 1:(length(xvals_to_cluster)), labels = xvals_to_cluster) +
  #scale_fill_manual(values=c( "orange","#999999","#D32F2F"),labels = c("Mixed", "Non-Vaccine Types","Vaccine Types"))+theme_minimal() +
  scale_color_manual(values = c("black", "#0072B2", "#CC79A7"),labels = c("Data", "NFDS Model","Neutral Model")) +
...
errorbar_plot + facet_wrap(~VT, ncol = 3, scales = "free")
```
