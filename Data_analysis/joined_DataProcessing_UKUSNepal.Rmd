...
par(mfrow = c(3,1))
barplot(Nepal_cluster_freqs[[5]][which(Nepal_cluster_freqs[[5]] + Nepal_cluster_freqs[[8]] + Nepal_cluster_freqs[[10]] > 0)]/sum(Nepal_cluster_freqs[[5]]), ylim = c(0, 0.1))
barplot(Nepal_cluster_freqs[[8]][which(Nepal_cluster_freqs[[5]] + Nepal_cluster_freqs[[8]] + Nepal_cluster_freqs[[10]] > 0)]/sum(Nepal_cluster_freqs[[8]]), col = "red")
barplot(Nepal_cluster_freqs[[10]][which(Nepal_cluster_freqs[[5]] + Nepal_cluster_freqs[[8]] + Nepal_cluster_freqs[[10]] > 0)]/sum(Nepal_cluster_freqs[[10]]), col = "blue")

Nepal_pre_vac_df <- data.frame(rbind(Nepal_cluster_freqs[[5]][which(Nepal_cluster_freqs[[5]] + Nepal_cluster_freqs[[8]] + Nepal_cluster_freqs[[10]] > 1)]/sum(Nepal_cluster_freqs[[5]]), Nepal_cluster_freqs[[8]][which(Nepal_cluster_freqs[[5]] + Nepal_cluster_freqs[[8]] + Nepal_cluster_freqs[[10]] > 1)]/sum(Nepal_cluster_freqs[[8]]), Nepal_cluster_freqs[[10]][which(Nepal_cluster_freqs[[5]] + Nepal_cluster_freqs[[8]] + Nepal_cluster_freqs[[10]] > 1)]/sum(Nepal_cluster_freqs[[10]])))
colnames(Nepal_pre_vac_df) <- unique(Nepal_PP$GPSC)[which(Nepal_cluster_freqs[[5]] + Nepal_cluster_freqs[[8]] + Nepal_cluster_freqs[[10]] > 1)]
...
# just for fun, add last time point (2021) to plot
Nepal_pre_and_post_vac_df <- data.frame(rbind(Nepal_cluster_freqs[[5]][which(Nepal_cluster_freqs[[5]] + Nepal_cluster_freqs[[8]] + Nepal_cluster_freqs[[10]] > 1)]/sum(Nepal_cluster_freqs[[5]]), Nepal_cluster_freqs[[8]][which(Nepal_cluster_freqs[[5]] + Nepal_cluster_freqs[[8]] + Nepal_cluster_freqs[[10]] > 1)]/sum(Nepal_cluster_freqs[[8]]), Nepal_cluster_freqs[[10]][which(Nepal_cluster_freqs[[5]] + Nepal_cluster_freqs[[8]] + Nepal_cluster_freqs[[10]] > 1)]/sum(Nepal_cluster_freqs[[10]]), Nepal_cluster_freqs[[13]][which(Nepal_cluster_freqs[[5]] + Nepal_cluster_freqs[[8]] + Nepal_cluster_freqs[[10]] > 1)]/sum(Nepal_cluster_freqs[[13]]), Nepal_cluster_freqs[[14]][which(Nepal_cluster_freqs[[5]] + Nepal_cluster_freqs[[8]] + Nepal_cluster_freqs[[10]] > 1)]/sum(Nepal_cluster_freqs[[14]]), Nepal_cluster_freqs[[15]][which(Nepal_cluster_freqs[[5]] + Nepal_cluster_freqs[[8]] + Nepal_cluster_freqs[[10]] > 1)]/sum(Nepal_cluster_freqs[[15]])))
colnames(Nepal_pre_and_post_vac_df) <- unique(Nepal_PP$GPSC)[which(Nepal_cluster_freqs[[5]] + Nepal_cluster_freqs[[8]] + Nepal_cluster_freqs[[10]] > 1)]
...
# make stacked barplot - with serotypes
```
