...
for (i in sort(unique(Nepal_PP$Serotype))){
  for (j in unique(Nepal_PP$GPSC)) {
    Nepal_cluster_sero_freqs_pre_post_df[(iter1+iter2-1),3] <- length(which(Nepal_meta_dataPP[Nepal_meta_IDtoIndPP[Nepal_PP[Nepal_PP$GPSC == j,][Nepal_PP[Nepal_PP$GPSC == j,]$Serotype==i,"sample"]],]$Year==Nepal_time_points_selected[5]))/length(which(Nepal_meta_dataPP$Year == "2009"))
    #print(iter1+iter2-1)
    iter1 <- iter1 + 1
  }
  iter2 <- iter2 + iter1 - 1
...
for (i in sort(unique(Nepal_PP$Serotype))){
  for (j in unique(Nepal_PP$GPSC)) {
    Nepal_cluster_sero_freqs_pre_post_df[(iter1+iter2-1),3] <- length(which(Nepal_meta_dataPP[Nepal_meta_IDtoIndPP[Nepal_PP[Nepal_PP$GPSC == j,][Nepal_PP[Nepal_PP$GPSC == j,]$Serotype==i,"sample"]],]$Year==Nepal_time_points_selected[15]))/length(which(Nepal_meta_dataPP$Year == "2019"))
    #print(iter1+iter2-1)
    iter1 <- iter1 + 1
  }
  iter2 <- iter2 + iter1 - 1
...
for (i in sort(names(Nepal_serotype_counts_selected))){
  for (j in names(Nepal_GPSC_counts_selected)) {
    Nepal_cluster_sero_freqs_pre_post_df_selected[(iter1+iter2-1),3] <- length(which(Nepal_meta_dataPP[Nepal_meta_IDtoIndPP[Nepal_PP[Nepal_PP$GPSC == j,][Nepal_PP[Nepal_PP$GPSC == j,]$Serotype==i,"sample"]],]$Year==Nepal_time_points_selected[5]))/length(which(Nepal_meta_dataPP$Year == "2009"))
    #print(iter1+iter2-1)
    iter1 <- iter1 + 1
  }
  iter2 <- iter2 + iter1 - 1
...
for (i in sort(names(Nepal_serotype_counts_selected))){
  for (j in names(Nepal_GPSC_counts_selected)) {
    Nepal_cluster_sero_freqs_pre_post_df_selected[(iter1+iter2-1),3] <- length(which(Nepal_meta_dataPP[Nepal_meta_IDtoIndPP[Nepal_PP[Nepal_PP$GPSC == j,][Nepal_PP[Nepal_PP$GPSC == j,]$Serotype==i,"sample"]],]$Year==Nepal_time_points_selected[15]))/length(which(Nepal_meta_dataPP$Year == "2019"))
    #print(iter1+iter2-1)
    iter1 <- iter1 + 1
  }
  iter2 <- iter2 + iter1 - 1
