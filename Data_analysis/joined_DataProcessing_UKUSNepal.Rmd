...
# find out which Nepal genomes are from carriage
...
Nepal_years <- unique(Nepal_meta_data_gps_joined$Year)
...
for (i in names(Nepal_carriage_year_dict)) {
  Nepal_numbers_year_month[12 * (Nepal_carriage_year_dict[i]-2005) + Nepal_carriage_month_dict[i],3] <- Nepal_numbers_year_month[12 * (Nepal_carriage_year_dict[i]-2005) + Nepal_carriage_month_dict[i],3] +1
}

plot(Nepal_numbers_year_month[,1] + 0.1 * Nepal_numbers_year_month[,2], Nepal_numbers_year_month[,3])
