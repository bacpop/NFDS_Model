# Model published in Lorenz, L.J., Hellewell, J., Horsfield, S.T. et al. A reusable model of pangenome selection informs optimal surveillance strategies over vaccine introductions. Genome Med 18, 131 (2026). https://doi.org/10.1186/s13073-026-01672-4
# It is a compartmental Wright-Fisher model with negative frequency-dependent selection that describes vaccine-replacement dynamics of Streptococcus pneumoniae.
# When running into errors, try running with odin_1.5.11, odin.dust_0.3.13, mcstate_0.9.22
