...
saveRDS(apply(as.matrix(consensus_intermed_gene_presence_absence_mtx_bool, ncol = GPSC_no)[,-1], c(1,2), as.double), file = "Genotypes_matrix.rds") # Genotypes matrix for model input
```
