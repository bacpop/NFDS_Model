...
#Pop_ini_test_mtx <- matrix(PPsero_startpop6[freq_clust, freq_sero], nrow = length(freq_clust), ncol = length(freq_sero)) # start population as matrix, and filtered down for frequenct GPSCs and serotypes
